...
def check_signal(symbol):
    try:
        ...
        # BUY BREAKOUT
        # ==========================================
        if current_close > opening_high and current_close > current_vwap and current_volume > avg_volume:
            print(
                f"🚀 ORB BUY : {symbol}"            )
            entry_price = current_close
            stop_loss = max(opening_low, current_low)  
            # - SL_BUFFER            
        ...
        # SELL BREAKDOWN
        # ==========================================
        if current_close < opening_low and current_close < current_vwap and current_volume > avg_volume:
            print(
                f"🔻 ORB SELL : {symbol}"            )
            entry_price = current_close
            stop_loss = min(opening_high, current_high)  
            # + SL_BUFFER            
