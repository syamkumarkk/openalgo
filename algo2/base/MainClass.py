...
from base.ORBAlgo import ORBAlgo
...
class MainClass:
    def __init__(self,index='NIFTY'):        
        ...
        api_key = 'c500357e9c6f85f7157bb96f873488fc5c7240b1048385d1bb63c005e94d25df'
        print(api_key)
        if not api_key:
            raise EnvironmentError("❌ OPENALGO_APIKEY environment variable not set")
        # hostval= os.getenv('HOST_SERVER')
        hostval= os.getenv('CLOUD_FLARE_URL')
        # hostval= 'https://newcastle-likely-nine-charge.trycloudflare.com'
        ...
        # Expiry utility
        self.orb_util =ORBAlgo(self.client)
